  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-[#0a0a0a]">
      ...
      <div className="w-full lg:w-[45%] xl:w-[40%] flex flex-col justify-center px-6 sm:px-12 lg:px-24 py-12 min-h-screen relative overflow-hidden">
        ...
        >
          ...
          <div className="space-y-4">
            {/* Google Auth Button - Prominent White */}
            <button
              type="button"
              className="w-full py-3.5 rounded-2xl text-[15px] font-semibold flex items-center justify-center gap-3 transition-all duration-300 bg-white hover:bg-gray-100 text-black shadow-[0_4px_14px_rgba(255,255,255,0.1)] hover:shadow-[0_6px_20px_rgba(255,255,255,0.15)] hover:-translate-y-0.5"
            >
            ...
            {/* Divider */}
            <div className="flex items-center gap-4 my-4 py-1">
            ...
            <form onSubmit={handleSubmit} autoComplete="off" className="space-y-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 rounded-2xl text-[15px] font-semibold flex items-center justify-center gap-2 transition-all duration-300 disabled:opacity-60 bg-[var(--accent-orange)] hover:opacity-90 text-white shadow-lg hover:-translate-y-0.5"
              >
      ...
      <div className="hidden lg:block w-full lg:w-[55%] xl:w-[60%] p-4 lg:p-6">
        ...
        >
          {/* Subtle glowing radial background inside the container */}
