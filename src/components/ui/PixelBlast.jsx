...
export default function PixelBlast({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      // IntersectionObserver for autoPauseOffscreen
      let io = null;
      if (typeof IntersectionObserver !== "undefined" && autoPauseOffscreen) {
      ...
      const mapToPixels = (e) => {
        ...
        if (rect.width === 0 || rect.height === 0) return { fx: -1, fy: -1, w: 1, h: 1 };
