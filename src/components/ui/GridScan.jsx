...
const GridScan = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("GridScan: WebGL context could not be created:", err?.message || err);
      return;
    }
  ...
  useEffect(() => {
    // Camera / face tracking is disabled: biometric processing is not consented on this site.
    return undefined;
